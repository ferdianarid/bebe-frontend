...
const Footer = () => {
    return (
        <React.Fragment>
            <SectionLayouts addingclass='px-4 py-10 mx-auto max-w-[1440px] md:px-24 md:py-10 bg-green-600'>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-y-10 md:gap-y-0 gap-x-5">
                    <div className="">
